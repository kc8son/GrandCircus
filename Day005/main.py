...
print("\n---===*** Part - named & default parameters 2 ***===---")
print(apt_search2(city="Grand Forks", max_rent=300))                # Call this function once with arguments for min_beds and pets_allowed both omitted.
print(apt_search2(city="Minneapolis", max_rent=800, min_beds=3))    # Then call it with just min_beds and no pets_allowed
