...
class MyTestCase(unittest.TestCase):
    ...
    ####################################################################################################
    #   3 of a kind - five tests
    def test_check_3ofa_kind001(self):
        self.assertEqual(main.check_3ofa_kind("s5", "s5", "s5"), 5)
